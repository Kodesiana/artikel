//     DurationParser.cs is part of PBXListener.
...
{
    /// <summary>
    /// Serial duration parser.
    /// </summary>
    /// <remarks>This implementation is tested on Panasonic KX-T616 model.</remarks>
    public class DurationParser : IParser
    {
        /// <summary>
        /// Parse specified input to match call duration pattern.
        /// </summary>
        ...
        {
            var match = Regex.Match(input, "[0-9]{2}:[0-9]{2}\\S[0-9]{1,3}");
