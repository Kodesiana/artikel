//     ExtensionParser.cs is part of PBXListener.
...
{
    /// <summary>
    /// Serial extension parser.
    /// </summary>
    /// <remarks>This implementation is tested on Panasonic KX-T616 model.</remarks>
    public class ExtensionParser : IParser
    {
        /// <summary>
        /// Parse specified input to match phone's extension pattern.
        /// </summary>
        ...
        {
            return Regex.Match(input, "\\s[0-9]{3}\\s").Value.Trim();
        }
    }
}
