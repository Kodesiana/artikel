//     PhoneNumberParser.cs is part of PBXListener.
...
{ 
    /// <summary>
    /// Serial phone number parser.
    /// </summary>
    /// <remarks>This implementation is tested on Panasonic KX-T616 model.</remarks>
    public class PhoneNumberParser : IParser
    {
        /// <summary>
        /// Parse specified input to match phone number pattern.
        /// </summary>
        ...
        {
            return Regex.Match(input, "\\s[0-9]{6,12}\\s").Value.Trim();
        }
    }
}
